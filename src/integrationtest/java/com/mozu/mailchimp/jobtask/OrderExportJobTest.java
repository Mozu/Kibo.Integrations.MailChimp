...
public class OrderExportJobTest extends BaseTest {

    private static final Logger logger = LoggerFactory.getLogger(OrderExportJobTest.class);
    ...
    public void test() throws Exception {
    	...
    	String fromDate="2013-02-21";
    	Timestamp importFromTimestamp = null;
        if (StringUtils.isNotBlank(fromDate)) {
          importFromTimestamp = Timestamp.valueOf(fromDate + " 00:00:00");
        }
    	JobExecution jobExecution=mozuMcClientSetupService.triggerBatch(mailchimpSetting, JobInfoUI.ORDER_EXPORT_JOB, importFromTimestamp);
